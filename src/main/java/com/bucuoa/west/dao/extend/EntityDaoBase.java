package com.bucuoa.west.dao.extend;
...
import com.bucuoa.west.dao.core.uitls.SQLUtil;
...
public class EntityDaoBase<T, PK extends Serializable> {
	...
	public Object saveEntity(T entity) throws Exception {
		String insertSql = SQLUtil.insertSql(entity);
	...
	public void updateEntity(T entity) throws Exception {
		String updateSql = SQLUtil.updateSql(entity);
	...
	public List<T> select(Class<T> class1, String[] filedk, String[] wheres,
		...
		try {
			...
			{
				 selectSql = SQLUtil.selectSql(classz, filedk, wheres, valuek,orderby,patterns);
			}else
			{
				 selectSql = SQLUtil.selectSql(classz, filedk, wheres, valuek);
			}
