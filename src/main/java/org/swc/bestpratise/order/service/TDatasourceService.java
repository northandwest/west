...
import org.swc.bestpratise.order.repository.TDatasourceDao;

import com.bucuoa.west.dao.extend.Page;

@Service
public class TDatasourceService {
	@Autowired
	private TDatasourceDao dao;

	public Object saveEntity(TDatasource entity) throws Exception {
		return dao.saveEntity(entity);
	}

	@Transactional
	public void update(TDatasource entity) throws Exception {
		dao.updateEntity(entity);
	}

	public TDatasource findEntityById(Long id) throws Exception {
	...
	public List<TDatasource> findEntityList(String[] keyName, String[] operate,
	...
	public List<TDatasource> myEntityList(String userId) throws Exception {
	...
	public Page getEntityPage(ServletRequest request) throws Exception {
		...
		List<TDatasource> data = dao.findEntityList(names, opt, params, 1000,
				pageNO);
	...
	public Page getAllEntityPage(HttpServletRequest request) throws Exception {
		...
		int count = dao.getEntityCount(new String[] {}, new String[] {},
				new Object[] {}, null);
		List<TDatasource> data = dao.findEntityList(new String[] {},
