...
import org.swc.bestpratise.order.repository.TProjectDao;
...
public class TProjectService {
	...
	public Object saveEntity(TProject entity) throws Exception {
		return dao.saveEntity(entity);
	}

	@Transactional
	public void update(TProject entity) throws Exception {
		dao.updateEntity(entity);
	}

	public TProject findEntityById(Long id) throws Exception {
	...
	public List<TProject> findEntityList(String[] keyName, String[] operate,
	...
	public List<TProject> myEntityList(String userId) throws Exception {
	...
	public Page getEntityPage(ServletRequest request) throws Exception {
		...
		List<TProject> data = dao.findEntityList(names, opt, params, 1000,
				pageNO);
	...
	public Page getAllEntityPage(HttpServletRequest request) throws Exception {
		...
		int count = dao.getEntityCount(new String[] {}, new String[] {},
				new Object[] {}, null);
		List<TProject> data = dao.findEntityList(new String[] {},
